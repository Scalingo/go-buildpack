...
* Add go1.26.4
* go1.26 defaults to 1.26.4
* Add go1.25.11
* go1.25 defaults to 1.25.11

## [v229] - 2026-05-08

* Add go1.26.3
* go1.26 defaults to 1.26.3
* Add go1.25.10
* go1.25 defaults to 1.25.10
...
* Add go1.25.7
* go1.25 defaults to 1.25.7
* Add go1.24.13
* go1.24 defaults to 1.24.13

## [v218] - 2026-01-16

* Add go1.24.12
* Add go1.25.6
* go1.24 defaults to 1.24.12
* go1.25 defaults to 1.25.6
...
* Add go1.24.10
* Add go1.25.4
* go1.24 defaults to 1.24.10
* go1.25 defaults to 1.25.4

## [v215] - 2025-10-14

* Add go1.24.9
* Add go1.25.3
* go1.24 defaults to 1.24.9
* go1.25 defaults to 1.25.3
...
[unreleased]: https://github.com/heroku/heroku-buildpack-go/compare/v230...main
...
[v217]: https://github.com/heroku/heroku-buildpack-go/compare/v216...v217
[v216]: https://github.com/heroku/heroku-buildpack-go/compare/v215...v216
[v215]: https://github.com/heroku/heroku-buildpack-go/compare/v214...v215
[v214]: https://github.com/heroku/heroku-buildpack-go/compare/v213...v214
